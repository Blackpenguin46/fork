...
function AcademyVideosPageContent() {
  const { user } = useAuth()
    ...
    const fetchResources = async () => {
      try {
        ...
        if (result.success && result.data) {
          ...
          console.warn('Failed to fetch videos:', result.error || 'Unknown error')
          setResources(null)
        }
      } catch (error) {
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white">Video Tutorials</h1>
              <p className="text-xl text-gray-300 mt-2">Educational videos and training content</p>
            </div>
          </div>
          
          <div className="flex items-center space-x-4 text-sm text-gray-400">
            <span>{resources?.count || 0} videos</span>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mb-4">
              {searchQuery ? 'Try adjusting your search or filters' : 'No videos are available yet'}
            </p>
          ...
          <>
            <div className="mb-6">
              <p className="text-gray-400">
                Showing {resources.data.length} of {resources.count} videos
                  ...
                  <CardContent>
                    ...
                    {resource.is_premium && !canAccessPremiumResources && (
                      <p className="text-xs text-yellow-400 mt-2">
                        Premium video - upgrade to access
                      </p>
                    )}
                  </CardContent>
                </Card>
