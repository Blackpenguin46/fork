      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            <div className="p-3 bg-green-500/10 border-green-500/20 border rounded-lg">
              <Mic className="h-8 w-8 text-green-400" />
            </div>
            <div>
              <h1 className="text-4xl font-bold text-white">Cybersecurity Podcasts</h1>
              <p className="text-xl text-gray-300 mt-2">Stay informed with expert discussions and industry insights</p>
            </div>
          </div>
          
          <div className="flex items-center space-x-4 text-sm text-gray-400">
            <span>{resources?.count || 0} podcasts</span>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-gray-400 mb-4">
              {searchQuery ? 'Try adjusting your search or filters' : 'No podcasts are available yet'}
            </p>
          ...
          <>
            <div className="mb-6">
              <p className="text-gray-400">
                Showing {resources.data.length} of {resources.count} podcasts
                  ...
                  <CardContent>
                    ...
                    {resource.is_premium && !canAccessPremiumResources && (
                      <p className="text-xs text-yellow-400 mt-2">
                        Premium podcast - upgrade to access
                      </p>
                    )}
                  </CardContent>
                </Card>
