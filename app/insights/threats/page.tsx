...
export default function InsightsThreatsPage() {
  const { user } = useAuth()
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            <div className="p-3 bg-red-500/10 border-red-500/20 border rounded-lg">
              <Shield className="h-8 w-8 text-red-400" />
            </div>
            <div>
              <h1 className="text-4xl font-bold text-white">Threat Intelligence</h1>
              <p className="text-xl text-gray-300 mt-2">Latest cybersecurity threats and attack vectors</p>
            </div>
          </div>
          
          <div className="flex items-center space-x-4 text-sm text-gray-400">
            <span>{resources?.count || 0} threat reports</span>
          ...
          <div className="flex flex-wrap gap-4 items-center">
            <Select value={selectedDifficulty} onValueChange={setSelectedDifficulty}>
              ...
              <SelectContent>
                ...
                <SelectItem value="beginner">Low</SelectItem>
                <SelectItem value="intermediate">Medium</SelectItem>
                <SelectItem value="advanced">High</SelectItem>
              </SelectContent>
            </Select>
            ...
            <Select value={premiumFilter} onValueChange={setPremiumFilter}>
              ...
              <SelectContent>
                ...
                <SelectItem value="premium">Premium Intel</SelectItem>
              </SelectContent>
            </Select>
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">No threat intelligence found</h3>
            <p className="text-gray-400 mb-4">
              {searchQuery ? 'Try adjusting your search or filters' : 'No threat intelligence is available yet'}
            </p>
          ...
          <>
            <div className="mb-6">
              <p className="text-gray-400">
                Showing {resources.data.length} of {resources.count} threat reports
                    ...
                    <div className="flex items-start justify-between">
                      <div className="flex items-center space-x-2">
                        ...
                        <Badge variant="outline" className={getDifficultyColor(resource.difficulty_level)}>
                          {resource.difficulty_level === 'beginner' ? 'Low' : 
                           resource.difficulty_level === 'intermediate' ? 'Medium' : 'High'}
                        </Badge>
                      </div>
                      {resource.is_premium && (
                  ...
                  <CardContent>
                    ...
                    {resource.is_premium && !canAccessPremiumResources && (
                      <p className="text-xs text-yellow-400 mt-2">
                        Premium threat intelligence - upgrade to access
                      </p>
                    )}
                  </CardContent>
                </Card>
