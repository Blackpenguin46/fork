...
export default function CommunitySkoolPage() {
  const { user } = useAuth()
    ...
    <div className="min-h-screen bg-deep-space-blue pt-16">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex items-center space-x-2 text-sm text-gray-400 mb-6">
          ...
          <ChevronRight className="h-4 w-4" />
          <span className="text-white">Skool</span>
        </div>
        ...
        <div className="mb-8">
          <div className="flex items-center space-x-4 mb-4">
            ...
            <div>
              <h1 className="text-4xl font-bold text-white">Skool Communities</h1>
              <p className="text-xl text-gray-300 mt-2">Join structured cybersecurity learning communities on Skool platform</p>
            </div>
          </div>
          
          <div className="flex items-center space-x-4 text-sm text-gray-400">
            <span>{resources?.count || 0} Skool communities</span>
        ...
        <div className="mb-8 space-y-4">
          ...
          <div className="relative">
            ...
            <Input
              placeholder="Search Skool communities..."
              value={searchQuery}
        ...
        {loading ? (
          ...
          <div className="text-center py-12">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">No Skool communities found</h3>
            <p className="text-gray-400 mb-4">
              {searchQuery ? 'Try adjusting your search or filters' : 'No Skool communities are available yet'}
            </p>
          ...
          <>
            ...
            <div className="mb-6">
              <p className="text-gray-400">
                Showing {resources.data.length} of {resources.count} Skool communities
            ...
            <div className={`grid ${viewMode === 'grid' ? 'grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4' : 'grid-cols-1'} gap-6 mb-8`}>
              {resources.data.map((resource) => (
                <Card key={resource.id} className="bg-gray-800/50 border-gray-700 hover:border-purple-500/50 transition-colors group">
                  <CardHeader>
