-- Simple Migration for Cybernex Academy
-- This migration adds all missing tables and columns without complex functions
...
-- Add constraints (will be ignored if they already exist)
...
-- Create new user_bookmarks table (rename old one if exists)
...
-- Add constraints to learning_paths
...
-- Add foreign key to user_progress
...
SELECT 'Simple migration completed successfully! All missing tables and columns have been added.' as status;